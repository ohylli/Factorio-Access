...
function load_tutorial(pindex)
   ...
   local CHAPTER_9_LENGTH = 26
   local CHAPTER_10_LENGTH = 99
   local CHAPTER_11_LENGTH = 99
   local CHAPTER_12_LENGTH = 99

   tutorial.chapter_lengths = {CHAPTER_1_LENGTH, CHAPTER_2_LENGTH, CHAPTER_3_LENGTH, CHAPTER_4_LENGTH, CHAPTER_5_LENGTH, CHAPTER_6_LENGTH, CHAPTER_7_LENGTH, CHAPTER_8_LENGTH, CHAPTER_9_LENGTH, CHAPTER_10_LENGTH, CHAPTER_11_LENGTH, CHAPTER_12_LENGTH}
